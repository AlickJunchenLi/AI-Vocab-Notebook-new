const ICON_PATHS = {
  ...
  sun: (
    <>
      ...
      <path d="M14 2v3M14 23v3M2 14h3M23 14h3M5.5 5.5l2.1 2.1M20.4 20.4l2.1 2.1M22.5 5.5l-2.1 2.1M7.6 20.4l-2.1 2.1" />
    </>
  ),
  flame: (
    <path d="M14.5 25c-5.2 0-8.5-3.5-8.5-8.2 0-3.6 2-6.3 5.3-9.7.1 2.7 1.2 4.4 2.8 5.3.1-4.2 2-7.5 5.1-10.4.4 4.4 2.8 6.6 2.8 10.4 0 2.1-.7 3.9-2 5.2-.2-2.4-1.3-4.3-3.4-5.8.2 3.3-1.3 5.1-3.2 6.5-1.2.9-1.7 2-1.5 3.4.2 1.3 1.2 2.5 2.6 3.3Z" />
  ),
  star: (
    <path d="m14 3 3.3 6.7 7.4 1.1-5.4 5.2 1.3 7.4-6.6-3.5-6.6 3.5 1.3-7.4-5.4-5.2 7.4-1.1Z" />
  ),
};
